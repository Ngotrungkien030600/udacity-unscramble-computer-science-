...
def main():
    ...
    if texts:
        ...
        print("Notextsrecordsavailablessssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss")

    if calls:
        last_call = calls[-1]
        print(f"Last record of calls: {last_call[0]} calls {last_call[1]} at time {last_call[2]}, lasting {last_call[3]} seconds")
    else:
        print("Nocallsrecordavailablessssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss")
